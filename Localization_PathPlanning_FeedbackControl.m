...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
robotposition1 = [25,72]; %You can change the robot position
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%Final position --> Bunu artık robot biliyor o yüzden control ve path
%planning burada devreye giriyor. Bu outputu control ve path planning
%fonksiyonları kullanacak.
...
% [estimated_x, estimated_y] = localize(robot_gridx, robot_gridy,map)
map = int8(~map);
...
% bu eldeki kx2 elemanlı waypointlerden oluşan bir path için yazılacak olan
% kontrolcü. ödevdekiyle benzer mantık belli noktaları takip edecek sadece.
% her bir elemandan 0.5 çıkarılabilir ama çok da şart mı bilmiyorum zamanla
% düzeltiriz en kötü
...
% theta0 = 0; % initial theta, you can change them to whatever you want
% 
%     
...
function [x_new, y_new, theta_new] = control(x_goal, y_goal, x_in, y_in, theta_in)
    ...
    %wheel_param = [alpha_r; beta_r; alpha_l; beta_l; r; lb];
    rho = ((x_goal-x_in)^2 + (y_goal-y_in)^2)^(1/2);
